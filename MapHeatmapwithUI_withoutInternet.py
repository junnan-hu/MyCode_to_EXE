...
"""
[文档介绍]
    此文件用于封装我的地图热图代码为exe，该文件有用户界面设计，操作上避免弹出多个窗口。
"""
...
def generate_map(summary_table_df, geojson_path, vmin_user, vmax_user,low_color, high_color):
    ...
    # --- 后续您的原始绘图逻辑（气泡大小、颜色映射、地图创建、图层添加、保存） ---
    # (3) 设置气泡大小映射
